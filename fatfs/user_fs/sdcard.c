...
#define SD_SPI_CLK_FAST           SPI_CR1_BR_0   //baudrate Fpclk/4(21 MHz)
...
)
{
  ...
  SPI1->CR1 |= SPI_CR1_DFF;/* Set SPI to 16-bit mode */
  ...
  SPI1->CR1 &= ~SPI_CR1_DFF;/* Set SPI to 8-bit mode */
}
