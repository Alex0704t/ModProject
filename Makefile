...
# Directories
#STM lib directory
STM_CORE_DIR:=			Drivers/CMSIS/Include
STM_DIR:=				Drivers/CMSIS/Device/ST/STM32F4xx
#Headers & source directory
INC_DIRS:=				$(STM_CORE_DIR) $(STM_DIR)/Include Inc
SRC_DIRS:=				Src
...
#STARTUP:=				startup/startup_stm32f4xx.c
